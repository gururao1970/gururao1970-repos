...
public class CatalogServlet extends HttpServlet { 
	...
	System.out.println("CatalogServlet:doGet#Session"+ sesion);

        // If the user has no cart, create a new one
        if (cart == null) {
            cart = new ShoppingCart();
			
			System.out.println("CatalogServlet:ShoppingCart");
	...
	// then write the data of the response
		...
		System.out.println("CatalogServlet:database###########" + database);
		...
		System.out.println("CatalogServlet:Number of books ###########" + database.getNumberOfBooks() );

		BookDetails[] books = database.getBooksSortedByTitle();
        int numBooks = database.getNumberOfBooks();
		System.out.println("CatalogServlet:getNumberOfBooks " + numBooks);
