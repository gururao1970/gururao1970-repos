...
public class BrowseNodeLookup  implements java.io.Serializable {
    ...
    private com.amazon.soap.AWSECommerceService.BrowseNodeLookupRequest shared;

    private com.amazon.soap.AWSECommerceService.BrowseNodeLookupRequest[] request;

    public BrowseNodeLookup() {
    }
    ...
    public BrowseNodeLookup(
           ...
           com.amazon.soap.AWSECommerceService.BrowseNodeLookupRequest shared,
           com.amazon.soap.AWSECommerceService.BrowseNodeLookupRequest[] request) {
    ...
    /**
     * Gets the marketplaceDomain value for this BrowseNodeLookup.
     * 
    ...
    /**
     * Sets the marketplaceDomain value for this BrowseNodeLookup.
     * 
    ...
    /**
     * Gets the AWSAccessKeyId value for this BrowseNodeLookup.
     * 
    ...
    /**
     * Sets the AWSAccessKeyId value for this BrowseNodeLookup.
     * 
    ...
    /**
     * Gets the subscriptionId value for this BrowseNodeLookup.
     * 
    ...
    /**
     * Sets the subscriptionId value for this BrowseNodeLookup.
     * 
    ...
    /**
     * Gets the associateTag value for this BrowseNodeLookup.
     * 
     * @return associateTag
     */
    ...
    /**
     * Sets the associateTag value for this BrowseNodeLookup.
     * 
     * @param associateTag
     */
    ...
    /**
     * Gets the validate value for this BrowseNodeLookup.
     * 
     * @return validate
     */
    ...
    /**
     * Sets the validate value for this BrowseNodeLookup.
     * 
     * @param validate
     */
    ...
    /**
     * Gets the XMLEscaping value for this BrowseNodeLookup.
     * 
     * @return XMLEscaping
     */
    ...
    /**
     * Sets the XMLEscaping value for this BrowseNodeLookup.
     * 
     * @param XMLEscaping
     */
    ...
    /**
     * Gets the shared value for this BrowseNodeLookup.
     * 
     * @return shared
     */
    public com.amazon.soap.AWSECommerceService.BrowseNodeLookupRequest getShared() {
        return shared;
    }


    /**
     * Sets the shared value for this BrowseNodeLookup.
     * 
     * @param shared
     */
    public void setShared(com.amazon.soap.AWSECommerceService.BrowseNodeLookupRequest shared) {
        this.shared = shared;
    }


    /**
     * Gets the request value for this BrowseNodeLookup.
     * 
     * @return request
     */
    public com.amazon.soap.AWSECommerceService.BrowseNodeLookupRequest[] getRequest() {
        return request;
    }


    /**
     * Sets the request value for this BrowseNodeLookup.
     * 
     * @param request
     */
    public void setRequest(com.amazon.soap.AWSECommerceService.BrowseNodeLookupRequest[] request) {
        this.request = request;
    }

    public com.amazon.soap.AWSECommerceService.BrowseNodeLookupRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, com.amazon.soap.AWSECommerceService.BrowseNodeLookupRequest _value) {
        this.request[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof BrowseNodeLookup)) return false;
        BrowseNodeLookup other = (BrowseNodeLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(BrowseNodeLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", ">BrowseNodeLookup"));
