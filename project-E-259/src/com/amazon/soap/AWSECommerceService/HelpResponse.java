...
public class HelpResponse  implements java.io.Serializable {
    ...
    private com.amazon.soap.AWSECommerceService.Information[] information;
    ...
    public HelpResponse(
           ...
           com.amazon.soap.AWSECommerceService.Information[] information) {
     ...
     * @return information
     */
    public com.amazon.soap.AWSECommerceService.Information[] getInformation() {
        return information;
    }
     ...
     * @param information
     */
    public void setInformation(com.amazon.soap.AWSECommerceService.Information[] information) {
        this.information = information;
    }

    public com.amazon.soap.AWSECommerceService.Information getInformation(int i) {
        return this.information[i];
    }

    public void setInformation(int i, com.amazon.soap.AWSECommerceService.Information _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", ">HelpResponse"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", "Information"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", "Information"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
