...
public class CustomerContentSearch  implements java.io.Serializable {
    ...
    private com.amazon.soap.AWSECommerceService.CustomerContentSearchRequest shared;

    private com.amazon.soap.AWSECommerceService.CustomerContentSearchRequest[] request;

    public CustomerContentSearch() {
    }
    ...
    public CustomerContentSearch(
           ...
           com.amazon.soap.AWSECommerceService.CustomerContentSearchRequest shared,
           com.amazon.soap.AWSECommerceService.CustomerContentSearchRequest[] request) {
    ...
    /**
     * Gets the marketplaceDomain value for this CustomerContentSearch.
     * 
    ...
    /**
     * Sets the marketplaceDomain value for this CustomerContentSearch.
     * 
    ...
    /**
     * Gets the AWSAccessKeyId value for this CustomerContentSearch.
     * 
    ...
    /**
     * Sets the AWSAccessKeyId value for this CustomerContentSearch.
     * 
    ...
    /**
     * Gets the subscriptionId value for this CustomerContentSearch.
     * 
    ...
    /**
     * Sets the subscriptionId value for this CustomerContentSearch.
     * 
    ...
    /**
     * Gets the associateTag value for this CustomerContentSearch.
     * 
     * @return associateTag
     */
    ...
    /**
     * Sets the associateTag value for this CustomerContentSearch.
     * 
     * @param associateTag
     */
    ...
    /**
     * Gets the validate value for this CustomerContentSearch.
     * 
     * @return validate
     */
    ...
    /**
     * Sets the validate value for this CustomerContentSearch.
     * 
     * @param validate
     */
    ...
    /**
     * Gets the XMLEscaping value for this CustomerContentSearch.
     * 
     * @return XMLEscaping
     */
    ...
    /**
     * Sets the XMLEscaping value for this CustomerContentSearch.
     * 
     * @param XMLEscaping
     */
    ...
    /**
     * Gets the shared value for this CustomerContentSearch.
     * 
     * @return shared
     */
    public com.amazon.soap.AWSECommerceService.CustomerContentSearchRequest getShared() {
        return shared;
    }


    /**
     * Sets the shared value for this CustomerContentSearch.
     * 
     * @param shared
     */
    public void setShared(com.amazon.soap.AWSECommerceService.CustomerContentSearchRequest shared) {
        this.shared = shared;
    }


    /**
     * Gets the request value for this CustomerContentSearch.
     * 
     * @return request
     */
    public com.amazon.soap.AWSECommerceService.CustomerContentSearchRequest[] getRequest() {
        return request;
    }


    /**
     * Sets the request value for this CustomerContentSearch.
     * 
     * @param request
     */
    public void setRequest(com.amazon.soap.AWSECommerceService.CustomerContentSearchRequest[] request) {
        this.request = request;
    }

    public com.amazon.soap.AWSECommerceService.CustomerContentSearchRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, com.amazon.soap.AWSECommerceService.CustomerContentSearchRequest _value) {
        this.request[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CustomerContentSearch)) return false;
        CustomerContentSearch other = (CustomerContentSearch) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CustomerContentSearch.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", ">CustomerContentSearch"));
