...
public class SellerListingSearch  implements java.io.Serializable {
    ...
    private com.amazon.soap.AWSECommerceService.SellerListingSearchRequest shared;

    private com.amazon.soap.AWSECommerceService.SellerListingSearchRequest[] request;

    public SellerListingSearch() {
    }
    ...
    public SellerListingSearch(
           ...
           com.amazon.soap.AWSECommerceService.SellerListingSearchRequest shared,
           com.amazon.soap.AWSECommerceService.SellerListingSearchRequest[] request) {
    ...
    /**
     * Gets the marketplaceDomain value for this SellerListingSearch.
     * 
    ...
    /**
     * Sets the marketplaceDomain value for this SellerListingSearch.
     * 
    ...
    /**
     * Gets the AWSAccessKeyId value for this SellerListingSearch.
     * 
    ...
    /**
     * Sets the AWSAccessKeyId value for this SellerListingSearch.
     * 
    ...
    /**
     * Gets the subscriptionId value for this SellerListingSearch.
     * 
    ...
    /**
     * Sets the subscriptionId value for this SellerListingSearch.
     * 
    ...
    /**
     * Gets the associateTag value for this SellerListingSearch.
     * 
     * @return associateTag
     */
    ...
    /**
     * Sets the associateTag value for this SellerListingSearch.
     * 
     * @param associateTag
     */
    ...
    /**
     * Gets the validate value for this SellerListingSearch.
     * 
     * @return validate
     */
    ...
    /**
     * Sets the validate value for this SellerListingSearch.
     * 
     * @param validate
     */
    ...
    /**
     * Gets the XMLEscaping value for this SellerListingSearch.
     * 
     * @return XMLEscaping
     */
    ...
    /**
     * Sets the XMLEscaping value for this SellerListingSearch.
     * 
     * @param XMLEscaping
     */
    ...
    /**
     * Gets the shared value for this SellerListingSearch.
     * 
     * @return shared
     */
    public com.amazon.soap.AWSECommerceService.SellerListingSearchRequest getShared() {
        return shared;
    }


    /**
     * Sets the shared value for this SellerListingSearch.
     * 
     * @param shared
     */
    public void setShared(com.amazon.soap.AWSECommerceService.SellerListingSearchRequest shared) {
        this.shared = shared;
    }


    /**
     * Gets the request value for this SellerListingSearch.
     * 
     * @return request
     */
    public com.amazon.soap.AWSECommerceService.SellerListingSearchRequest[] getRequest() {
        return request;
    }


    /**
     * Sets the request value for this SellerListingSearch.
     * 
     * @param request
     */
    public void setRequest(com.amazon.soap.AWSECommerceService.SellerListingSearchRequest[] request) {
        this.request = request;
    }

    public com.amazon.soap.AWSECommerceService.SellerListingSearchRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, com.amazon.soap.AWSECommerceService.SellerListingSearchRequest _value) {
        this.request[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof SellerListingSearch)) return false;
        SellerListingSearch other = (SellerListingSearch) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(SellerListingSearch.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", ">SellerListingSearch"));
