...
public class ItemSearch  implements java.io.Serializable {
    ...
    private com.amazon.soap.AWSECommerceService.ItemSearchRequest shared;

    private com.amazon.soap.AWSECommerceService.ItemSearchRequest[] request;
    ...
    public ItemSearch(
           ...
           com.amazon.soap.AWSECommerceService.ItemSearchRequest shared,
           com.amazon.soap.AWSECommerceService.ItemSearchRequest[] request) {
    ...
    /**
     * Gets the marketplaceDomain value for this ItemSearch.
     * 
    ...
    /**
     * Sets the marketplaceDomain value for this ItemSearch.
     * 
    ...
    /**
     * Gets the AWSAccessKeyId value for this ItemSearch.
     * 
    ...
    /**
     * Sets the AWSAccessKeyId value for this ItemSearch.
     * 
    ...
    /**
     * Gets the subscriptionId value for this ItemSearch.
     * 
    ...
    /**
     * Sets the subscriptionId value for this ItemSearch.
     * 
    ...
    /**
     * Gets the associateTag value for this ItemSearch.
     * 
     * @return associateTag
     */
    ...
    /**
     * Sets the associateTag value for this ItemSearch.
     * 
     * @param associateTag
     */
    ...
    /**
     * Gets the XMLEscaping value for this ItemSearch.
     * 
     * @return XMLEscaping
     */
    ...
    /**
     * Sets the XMLEscaping value for this ItemSearch.
     * 
     * @param XMLEscaping
     */
    ...
    /**
     * Gets the validate value for this ItemSearch.
     * 
     * @return validate
     */
    ...
    /**
     * Sets the validate value for this ItemSearch.
     * 
     * @param validate
     */
    ...
    /**
     * Gets the shared value for this ItemSearch.
     * 
     * @return shared
     */
    public com.amazon.soap.AWSECommerceService.ItemSearchRequest getShared() {
        return shared;
    }


    /**
     * Sets the shared value for this ItemSearch.
     * 
     * @param shared
     */
    public void setShared(com.amazon.soap.AWSECommerceService.ItemSearchRequest shared) {
        this.shared = shared;
    }


    /**
     * Gets the request value for this ItemSearch.
     * 
     * @return request
     */
    public com.amazon.soap.AWSECommerceService.ItemSearchRequest[] getRequest() {
        return request;
    }


    /**
     * Sets the request value for this ItemSearch.
     * 
     * @param request
     */
    public void setRequest(com.amazon.soap.AWSECommerceService.ItemSearchRequest[] request) {
        this.request = request;
    }

    public com.amazon.soap.AWSECommerceService.ItemSearchRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, com.amazon.soap.AWSECommerceService.ItemSearchRequest _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", ">ItemSearch"));
