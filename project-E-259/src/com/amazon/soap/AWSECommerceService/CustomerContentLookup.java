...
public class CustomerContentLookup  implements java.io.Serializable {
    ...
    private com.amazon.soap.AWSECommerceService.CustomerContentLookupRequest shared;

    private com.amazon.soap.AWSECommerceService.CustomerContentLookupRequest[] request;

    public CustomerContentLookup() {
    }
    ...
    public CustomerContentLookup(
           ...
           com.amazon.soap.AWSECommerceService.CustomerContentLookupRequest shared,
           com.amazon.soap.AWSECommerceService.CustomerContentLookupRequest[] request) {
    ...
    /**
     * Gets the marketplaceDomain value for this CustomerContentLookup.
     * 
    ...
    /**
     * Sets the marketplaceDomain value for this CustomerContentLookup.
     * 
    ...
    /**
     * Gets the AWSAccessKeyId value for this CustomerContentLookup.
     * 
    ...
    /**
     * Sets the AWSAccessKeyId value for this CustomerContentLookup.
     * 
    ...
    /**
     * Gets the subscriptionId value for this CustomerContentLookup.
     * 
    ...
    /**
     * Sets the subscriptionId value for this CustomerContentLookup.
     * 
    ...
    /**
     * Gets the associateTag value for this CustomerContentLookup.
     * 
     * @return associateTag
     */
    ...
    /**
     * Sets the associateTag value for this CustomerContentLookup.
     * 
     * @param associateTag
     */
    ...
    /**
     * Gets the validate value for this CustomerContentLookup.
     * 
     * @return validate
     */
    ...
    /**
     * Sets the validate value for this CustomerContentLookup.
     * 
     * @param validate
     */
    ...
    /**
     * Gets the XMLEscaping value for this CustomerContentLookup.
     * 
     * @return XMLEscaping
     */
    ...
    /**
     * Sets the XMLEscaping value for this CustomerContentLookup.
     * 
     * @param XMLEscaping
     */
    ...
    /**
     * Gets the shared value for this CustomerContentLookup.
     * 
     * @return shared
     */
    public com.amazon.soap.AWSECommerceService.CustomerContentLookupRequest getShared() {
        return shared;
    }


    /**
     * Sets the shared value for this CustomerContentLookup.
     * 
     * @param shared
     */
    public void setShared(com.amazon.soap.AWSECommerceService.CustomerContentLookupRequest shared) {
        this.shared = shared;
    }


    /**
     * Gets the request value for this CustomerContentLookup.
     * 
     * @return request
     */
    public com.amazon.soap.AWSECommerceService.CustomerContentLookupRequest[] getRequest() {
        return request;
    }


    /**
     * Sets the request value for this CustomerContentLookup.
     * 
     * @param request
     */
    public void setRequest(com.amazon.soap.AWSECommerceService.CustomerContentLookupRequest[] request) {
        this.request = request;
    }

    public com.amazon.soap.AWSECommerceService.CustomerContentLookupRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, com.amazon.soap.AWSECommerceService.CustomerContentLookupRequest _value) {
        this.request[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof CustomerContentLookup)) return false;
        CustomerContentLookup other = (CustomerContentLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(CustomerContentLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", ">CustomerContentLookup"));
