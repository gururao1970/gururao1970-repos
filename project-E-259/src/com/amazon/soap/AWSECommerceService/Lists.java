...
public class Lists  implements java.io.Serializable {
    ...
    private com.amazon.soap.AWSECommerceService.List[] list;
    ...
    public Lists(
           ...
           com.amazon.soap.AWSECommerceService.List[] list) {
     ...
     * @return list
     */
    public com.amazon.soap.AWSECommerceService.List[] getList() {
        return list;
    }
     ...
     * @param list
     */
    public void setList(com.amazon.soap.AWSECommerceService.List[] list) {
        this.list = list;
    }

    public com.amazon.soap.AWSECommerceService.List getList(int i) {
        return this.list[i];
    }

    public void setList(int i, com.amazon.soap.AWSECommerceService.List _value) {
        this.list[i] = _value;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", ">Lists"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", "List"));
        elemField.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", "List"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
