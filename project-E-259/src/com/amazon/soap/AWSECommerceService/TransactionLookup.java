...
public class TransactionLookup  implements java.io.Serializable {
    ...
    private com.amazon.soap.AWSECommerceService.TransactionLookupRequest shared;

    private com.amazon.soap.AWSECommerceService.TransactionLookupRequest[] request;
    ...
    public TransactionLookup(
           ...
           com.amazon.soap.AWSECommerceService.TransactionLookupRequest shared,
           com.amazon.soap.AWSECommerceService.TransactionLookupRequest[] request) {
    ...
    /**
     * Gets the marketplaceDomain value for this TransactionLookup.
     * 
    ...
    /**
     * Sets the marketplaceDomain value for this TransactionLookup.
     * 
    ...
    /**
     * Gets the AWSAccessKeyId value for this TransactionLookup.
     * 
    ...
    /**
     * Sets the AWSAccessKeyId value for this TransactionLookup.
     * 
    ...
    /**
     * Gets the subscriptionId value for this TransactionLookup.
     * 
    ...
    /**
     * Sets the subscriptionId value for this TransactionLookup.
     * 
    ...
    /**
     * Gets the associateTag value for this TransactionLookup.
     * 
     * @return associateTag
     */
    ...
    /**
     * Sets the associateTag value for this TransactionLookup.
     * 
     * @param associateTag
     */
    ...
    /**
     * Gets the validate value for this TransactionLookup.
     * 
     * @return validate
     */
    ...
    /**
     * Sets the validate value for this TransactionLookup.
     * 
     * @param validate
     */
    ...
    /**
     * Gets the XMLEscaping value for this TransactionLookup.
     * 
     * @return XMLEscaping
     */
    ...
    /**
     * Sets the XMLEscaping value for this TransactionLookup.
     * 
     * @param XMLEscaping
     */
    ...
    /**
     * Gets the shared value for this TransactionLookup.
     * 
     * @return shared
     */
    public com.amazon.soap.AWSECommerceService.TransactionLookupRequest getShared() {
        return shared;
    }


    /**
     * Sets the shared value for this TransactionLookup.
     * 
     * @param shared
     */
    public void setShared(com.amazon.soap.AWSECommerceService.TransactionLookupRequest shared) {
        this.shared = shared;
    }


    /**
     * Gets the request value for this TransactionLookup.
     * 
     * @return request
     */
    public com.amazon.soap.AWSECommerceService.TransactionLookupRequest[] getRequest() {
        return request;
    }


    /**
     * Sets the request value for this TransactionLookup.
     * 
     * @param request
     */
    public void setRequest(com.amazon.soap.AWSECommerceService.TransactionLookupRequest[] request) {
        this.request = request;
    }

    public com.amazon.soap.AWSECommerceService.TransactionLookupRequest getRequest(int i) {
        return this.request[i];
    }

    public void setRequest(int i, com.amazon.soap.AWSECommerceService.TransactionLookupRequest _value) {
        this.request[i] = _value;
    }

    private java.lang.Object __equalsCalc = null;
    public synchronized boolean equals(java.lang.Object obj) {
        if (!(obj instanceof TransactionLookup)) return false;
        TransactionLookup other = (TransactionLookup) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(TransactionLookup.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", ">TransactionLookup"));
