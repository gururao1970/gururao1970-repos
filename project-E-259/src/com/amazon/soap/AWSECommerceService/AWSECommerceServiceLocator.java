...
public class AWSECommerceServiceLocator extends org.apache.axis.client.Service implements com.amazon.soap.AWSECommerceService.AWSECommerceService {
    ...
    public com.amazon.soap.AWSECommerceService.AWSECommerceServicePortType getAWSECommerceServicePort() throws javax.xml.rpc.ServiceException {
    ...
    public com.amazon.soap.AWSECommerceService.AWSECommerceServicePortType getAWSECommerceServicePort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.amazon.soap.AWSECommerceService.AWSECommerceServiceBindingStub _stub = new com.amazon.soap.AWSECommerceService.AWSECommerceServiceBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.amazon.soap.AWSECommerceService.AWSECommerceServicePortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.amazon.soap.AWSECommerceService.AWSECommerceServiceBindingStub _stub = new com.amazon.soap.AWSECommerceService.AWSECommerceServiceBindingStub(new java.net.URL(AWSECommerceServicePort_address), this);
                _stub.setPortName(getAWSECommerceServicePortWSDDServiceName());
                return _stub;
            }
        }
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", "AWSECommerceService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", "AWSECommerceServicePort"));
        }
