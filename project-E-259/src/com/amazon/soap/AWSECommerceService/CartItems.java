...
public class CartItems  implements java.io.Serializable {
    ...
    private com.amazon.soap.AWSECommerceService.CartItem[] cartItem;
    ...
    public CartItems(
           ...
           com.amazon.soap.AWSECommerceService.CartItem[] cartItem) {
     ...
     * @return cartItem
     */
    public com.amazon.soap.AWSECommerceService.CartItem[] getCartItem() {
        return cartItem;
    }
     ...
     * @param cartItem
     */
    public void setCartItem(com.amazon.soap.AWSECommerceService.CartItem[] cartItem) {
        this.cartItem = cartItem;
    }

    public com.amazon.soap.AWSECommerceService.CartItem getCartItem(int i) {
        return this.cartItem[i];
    }

    public void setCartItem(int i, com.amazon.soap.AWSECommerceService.CartItem _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", ">CartItems"));
        ...
        elemField.setXmlName(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", "CartItem"));
