...
public class CartCreateRequest  implements java.io.Serializable {
    ...
    private com.amazon.soap.AWSECommerceService.CartCreateRequestItemsItem[] items;
    ...
    public CartCreateRequest(
           ...
           com.amazon.soap.AWSECommerceService.CartCreateRequestItemsItem[] items,
     ...
     * @return items
     */
    public com.amazon.soap.AWSECommerceService.CartCreateRequestItemsItem[] getItems() {
        return items;
    }
     ...
     * @param items
     */
    public void setItems(com.amazon.soap.AWSECommerceService.CartCreateRequestItemsItem[] items) {
        this.items = items;
    }
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", "CartCreateRequest"));
        ...
        elemField.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", ">>CartCreateRequest>Items>Item"));
        elemField.setMinOccurs(0);
        elemField.setNillable(false);
