...
public class Sellers  implements java.io.Serializable {
    ...
    public com.amazon.soap.AWSECommerceService.Seller getSeller(int i) {
        return this.seller[i];
    }

    public void setSeller(int i, com.amazon.soap.AWSECommerceService.Seller _value) {
    ...
    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://webservices.amazon.com/AWSECommerceService/2007-02-22", ">Sellers"));
